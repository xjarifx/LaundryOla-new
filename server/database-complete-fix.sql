-- =======================================
-- VIEW FIX - RECREATE VIEW WITH PROPER COLUMN MAPPING
-- =======================================

-- Drop and recreate the view to ensure column mapping is correct
DROP VIEW IF EXISTS view_all_orders;

-- Recreate All Orders View with proper column names
...
SELECT 
    ...
    o.status,
    o.order_date,  -- Keep original column name for ordering
...
-- =======================================
-- UPDATE STORED PROCEDURE TO USE order_date
-- =======================================

-- Drop and recreate the stored procedure to use the correct column name
...
BEGIN
    IF p_user_type = 'CUSTOMER' THEN
        ...
        -- Customer's recent orders (using order_date from original table)
    ...
    ELSEIF p_user_type = 'EMPLOYEE' THEN
        ...
        -- Pending orders for employee to accept (using order_date)
        SELECT * FROM view_all_orders 
...
-- Test the fixed procedure and view
